...
export default function HomeDashboard() {
  ...
  const [costRoi, setCostRoi] = useState({
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const riskRes = await axios.get(
          `${BACKEND_URL}/api/governance/risk-metrics`,
        );
        setRiskData({
        ...
        console.warn(
          "Could not fetch from FastAPI backend, using high-fidelity mock fallbacks: ",
          error.message,
        );
      }
    };
      ...
      >
        ...
        <Box sx={{ height: "100%" }}>
          ...
          >
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  borderRadius: "12px",
                  background:
                    "linear-gradient(135deg, rgba(0, 24, 168, 0.15) 0%, rgba(45, 212, 191, 0.2) 100%)",
            ...
            <Box
              sx={{ display: "flex", flexDirection: "column", gap: 0.8, mt: 1 }}
            >
              {[
                {
                  label: "Compliance",
                  value: governanceScore.components?.compliance || 95,
                  color: "#2DD4BF",
                },
                {
                  label: "Risk Management",
                  value: governanceScore.components?.risk_management || 98,
                  color: "#3B82F6",
                },
                {
                  label: "Ethics & ESG",
                  value: governanceScore.components?.sustainability || 96,
                  color: "#10B981",
                },
              ].map((metric, idx) => (
                <Box key={idx}>
        ...
        <Box sx={{ height: "100%" }}>
          ...
          >
            ...
            >
              Green computing auto-scaling active on Loans & Core Banking
              servers.
            </Typography>
          </Card>
        </Box>
          ...
          >
            ...
            <Box
              sx={{
                ...
                borderRadius: "6px",
                border: "1px solid rgba(0, 24, 168, 0.05)",
                my: 0.5,
              }}
            >
        ...
        <Box sx={{ height: "100%" }}>
          <Card
            className="glass-card"
            onClick={() =>
              navigate("/ai", { state: { filterSeverity: "high" } })
            }
            sx={{
              p: 2,
              height: "100%",
            ...
            >
              <Box
                sx={{
                  ...
                  height: 70,
                  background:
                    "conic-gradient(from 270deg at 50% 100%, #10B981 0deg 60deg, #F59E0B 60deg 120deg, #EF4444 120deg 180deg)",
            ...
            <Box sx={{ my: 0.8 }}>
              ...
              <LinearProgress
                ...
                sx={{
                  ...
                  "& .MuiLinearProgress-bar": {
                    background:
                      "linear-gradient(90deg, #6D28D9 0%, #F59E0B 100%)",
                    borderRadius: 2.5,
                  },
                }}
              />
          ...
          >
            ...
            >
              ...
              <Chip
                icon={
                  <CheckCircleIcon
                    sx={{ fontSize: "0.8rem", color: "white !important" }}
                  />
                }
            ...
            <Box
              sx={{
                ...
                justifyContent: "space-between",
                pt: 0.5,
                borderTop: "1px solid rgba(0, 24, 168, 0.06)",
              }}
            >
              <Typography
                variant="caption"
              ...
              >
                Resp:{" "}
                <strong style={{ color: "#0018A8" }}>
                  {systemHealth.api_response_time}
                </strong>
              </Typography>
              <Typography
                variant="caption"
